...
const Review = () => {
  ...
  <section className='container mx-auto mb-8 mt-12' id='review'>
    <div className="flex flex-col">
        <p className="mb-10 text-3xl font-light leading-normal  text-white tracking-tighter lg:mx-40 lg:mg-40 lg:text-[3.5rem]">
            {REVIEW.content}
        </p>
        <div className="flex items-center justify-center gap-6">
            <img src={xaviour} alt={REVIEW.name}  height={80} width={80}/>
            <div className="tracking-tighter">
                <h6 className='text-white'>{REVIEW.name}</h6>
